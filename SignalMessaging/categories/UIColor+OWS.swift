//
// Copyright 2019 Link Messenger, LLC
...
public extension UIColor {
    ...
    class var ows_signalBlue: UIColor {
        return UIColor(rgbHex: 0x007AFF)
    }
    ...
    @objc(ows_lightLinkBackgroundColor)
     class var ows_link_background: UIColor {
         return UIColor(rgbHex: 0xf2f2f7)
     }
     @objc(ows_darkLinkBackgroundColor)
     class var ows_dark_link_background: UIColor {
    ...
    @objc(ows_linkPrimaryColor)
         class var ows_linkPrimary: UIColor {
             return UIColor(rgbHex: 0x007AFF)
         }
         @objc(ows_linkPrimaryDarkColor)
         class var ows_linkPrimaryDark: UIColor {
             return UIColor(rgbHex: 0x0a84ff)
         }
