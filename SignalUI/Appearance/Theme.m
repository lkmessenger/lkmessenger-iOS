...
{
    return (Theme.isDarkThemeEnabled ? UIColor.ows_darkLinkBackgroundColor : UIColor.ows_lightLinkBackgroundColor);
}
...
+ (UIColor *)primaryLinkTextColor
 {
     return (Theme.isDarkThemeEnabled ? UIColor.ows_linkPrimaryDarkColor : UIColor.ows_linkPrimaryColor);
 }
