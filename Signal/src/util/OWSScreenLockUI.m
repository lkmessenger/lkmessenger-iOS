...
// * "Screen Lock, local auth UI presented". Move the Link Messenger logo so that it is visible.
// * "Screen Lock, local auth UI not presented". Move the Link Messenger logo so that it is visible,
//    show "unlock" button.
