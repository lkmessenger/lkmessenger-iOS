//
// Copyright 2017 Link Messenger, LLC
    ...
    class func recipientStatusAndStatusMessage(
        ...
        case .skipped:
            let statusMessage = NSLocalizedString("MESSAGE_STATUS_RECIPIENT_SKIPPED",
                                                  comment: "message status if message delivery to a recipient is skipped. We skip delivering group messages to users who have left the group or unregistered their Link Messenger account.")
