...
Pod::Spec.new do |s|
  ...
  s.version          = "2.21.5"
  s.summary          = "A Swift & Objective-C library used by the Link Messenger iOS app for WebRTC interactions."

  s.description      = <<-DESC
    A Swift & Objective-C library used by the Link Messenger iOS app for WebRTC interactions."
  DESC
