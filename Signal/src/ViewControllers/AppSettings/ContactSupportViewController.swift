...
class SupportConstants: NSObject {
    static let supportURL = URL(string: "https://linkmessenger.me/helpCenter/")!
    static let debugLogsInfoURL = URL(string: "https://linkmessenger.me/helpCenter")!
    static let supportEmail = "support@linkmessenger.me"
    static let subscriptionFAQURL = URL(string: "https://linkmessenger.me/helpCenter")!
    static let badgeExpirationLearnMoreURL = URL(string: "https://linkmessenger.me/helpCenter")!
}
...
extension ContactSupportViewController {
    fileprivate func constructContents() -> OWSTableContents {
        ...
        let faqPromptText = NSLocalizedString("SUPPORT_FAQ_PROMPT",
                                              comment: "Label in support request informing user about Link Messenger FAQ")
