    ...
    private func presentSMSInvitationSheet(for phoneNumber: String) {
        let actionSheet = ActionSheetController(
            title: OWSLocalizedString(
                ...
                comment: "Alert title. Shown after selecting a phone number that isn't a Link Messenger user."
            ),
            message: String(
                format: OWSLocalizedString(
                    "RECIPIENT_PICKER_INVITE_MESSAGE",
                    comment: "Alert text. Shown after selecting a phone number that isn't a Link Messenger user."
                ),
        ...
        actionSheet.addAction(ActionSheetAction(
            title: OWSLocalizedString(
                ...
                comment: "Button. Shown after selecting a phone number that isn't a Link Messenger user. Tapping the button will open a view that allows the user to send an SMS message to specified phone number."
            ),
            style: .default,
