//
// Copyright 2016 Link Messenger, LLC
...
public class InviteFlow: NSObject, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, ContactsPickerDelegate {
    ...
    public func sendSMSTo(phoneNumbers: [String]) {
        ...
        let inviteText = OWSLocalizedString("SMS_INVITE_BODY", comment: "body sent to contacts when inviting to Install Link Messenger")
    ...
    private func sendMailTo(emails recipientEmails: [String]) {
        ...
        let subject = OWSLocalizedString("EMAIL_INVITE_SUBJECT", comment: "subject of email sent to contacts when inviting to install Link Messenger")
        let bodyFormat = OWSLocalizedString("EMAIL_INVITE_BODY", comment: "body of email sent to contacts when inviting to install Link Messenger. Embeds {{link to install Link Messenger}} and {{link to the Link Messenger home page}}")
