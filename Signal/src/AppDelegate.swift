    ...
    static func applicationShortcutItems(isRegisteredAndReady: Bool) -> [UIApplicationShortcutItem] {
        ...
        return [.init(
            ...
            localizedTitle: NSLocalizedString(
                ...
                comment: "On the iOS home screen, if you tap and hold the Link Messenger icon, this shortcut will appear. Tapping it will let users send a new message. You may want to refer to similar behavior in other iOS apps, such as Messages, for equivalent strings."
            ),
