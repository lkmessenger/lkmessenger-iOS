    ...
    private func didTapToContinueOneTimeDonation() {
        ...
        case .noAmountSelected:
            showError(NSLocalizedString(
                ...
                comment: "If the user tries to donate to Link Messenger but no amount is selected, this error message is shown."
            ))
        case .amountIsTooSmall:
            showError(NSLocalizedString(
                "DONATE_SCREEN_ERROR_SELECT_A_LARGER_AMOUNT",
                comment: "If the user tries to donate to Link Messenger but they've entered an amount that's too small, this error message is shown."
            ))
        case .amountIsTooLarge:
            showError(NSLocalizedString(
                "DONATE_SCREEN_ERROR_SELECT_A_SMALLER_AMOUNT",
                comment: "If the user tries to donate to Link Messenger but they've entered an amount that's too large, this error message is shown."
            ))
