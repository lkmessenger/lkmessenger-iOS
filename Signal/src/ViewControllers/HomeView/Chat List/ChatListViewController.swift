        ...
        let formatString = { () -> String in
            ...
            case 0:
                return OWSLocalizedString(
                    ...
                    comment: "A label offering to start a new conversation with your contacts, if you have no Link Messenger contacts."
                )
            case 1:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_1_CONTACT_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 1 Link Messenger contact.  Embeds {{The name of 1 of your Link Messenger contacts}}."
                )
            case 2:
                return OWSLocalizedString(
                    "HOME_VIEW_FIRST_CONVERSATION_OFFER_2_CONTACTS_FORMAT",
                    comment: "Format string for a label offering to start a new conversation with your contacts, if you have 2 Link Messenger contacts.  Embeds {{The names of 2 of your Link Messenger contacts}}."
                )
            case 3:
                break
            default:
            ...
            return OWSLocalizedString(
                ...
                comment: "Format string for a label offering to start a new conversation with your contacts, if you have at least 3 Link Messenger contacts.  Embeds {{The names of 3 of your Link Messenger contacts}}."
            )
        }()
