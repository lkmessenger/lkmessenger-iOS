    ...
    func updateTableContents() {
        ...
        if self.signalService.hasCensoredPhoneNumber {
            ...
            censorshipCircumventionSection.footerTitle = NSLocalizedString(
                ...
                comment: "Table footer for the 'censorship circumvention' section shown when the app is connected to the Link Messenger service."
            )
        ...
        proxySection.footerAttributedTitle = .composed(of: [
            ...
            " ",
            CommonStrings.learnMore.styled(with: .link(URL(string: "https://linkmessenger.me/helpCenter")!))
        ]).styled(
