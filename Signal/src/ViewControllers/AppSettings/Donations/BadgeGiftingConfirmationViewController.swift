...
extension BadgeGiftingConfirmationViewController: PKPaymentAuthorizationControllerDelegate {
    ...
    func paymentAuthorizationController(
        ...
        firstly(on: .global()) { () -> Promise<PreparedPayment> in
            ...
            //
            // This *could* happen without a Link Messenger developer making a mistake, if the app is terminated at the right time.
            ...
            //
            // There are some invalid sad paths that we try to handle, but those indicate Link Messenger bugs.
