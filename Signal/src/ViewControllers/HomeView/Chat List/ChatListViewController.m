...
- (void)updateBarButtonItems
{
    ...
    compose.tintColor = [UIColor systemBlueColor];
    ...
    camera.tintColor = [UIColor systemBlueColor];
...
// If the user has *just* launched Link Messenger they intend to do something, we don't want to interrupt them.
